                                ...
                                <div class="col-sm-12">
                                    <table id="datatables-column-search-text-inputs" class="table table-striped dataTable" style="width: 100%;"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><a href="<?= route('operator/orders/edit/', $order['code']) ?>"><?= $order['code']; ?></a></td>
                                                <td><?= $order['name']; ?></td>
                                                <td>
                                                    <span class="badge fs-5 rounded-pill bg-success"><?= $order['division_status'] == 'complete' ? 'selesai' : '' ?></span>
                                                </td>
