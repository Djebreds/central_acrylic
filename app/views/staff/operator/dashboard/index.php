<div class="container-fluid p-0">
    ...
    <div class="row position-relative">
        <?php foreach($data['orders'] as $order) : ?>
            <?php if ($order['status_division'] == 'initial') { ?>
                <div class="col-12 col-md-3">
                    <div class="card bg-warning bg-opacity-50 text-dark" style="border-radius: 15px;">
                        <div class="card-body text-center">
                            ...
                            <p><a href="<?= route('operator/orders/edit/', $order['code']) ?>" class="stretched-link text-dark text-decoration-none"><?= $order['order_file']; ?></a></p>
