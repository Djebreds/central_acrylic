                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex gap-3">
                                                    <a href="<?= route('admin/products/update/', $product['id']) ?>" class="btn btn-warning " data-bs-toggle="modal" data-bs-target="#editModal-<?= $product['id'] ?>">
                                                    ...
                                                    <a href="<?= route('admin/products/delete/', $product['id']) ?>" onclick="return confirm('Hapus produk ini?');" class="btn btn-danger">
