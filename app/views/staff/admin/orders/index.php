                                ...
                                <div class="col-sm-12">
                                    <table id="datatables-column-search-text-inputs" class="table table-striped dataTable" style="width: 100%;"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><a href="<?= route('admin/orders/detail/', $order['code']) ?>"><?= $order['code']; ?></a></td>
                                                <td><?= $order['name']; ?></td>
                                                <td>
                                                ...
                                                <td><a href="<?= asset('uploaded/' . $order['order_file']) ?>" download onclick="return confirm('Ingin menyimpn file ini?')">Download</a></td>
                                            </tr>
                                            <?php endforeach ?>
                                        </tbody>
                                        <tfoot></tfoot>
